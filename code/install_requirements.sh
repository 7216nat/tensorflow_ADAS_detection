...
if grep -s -q "MX8MQ" /sys/firmware/devicetree/base/model; then
  ...
  # Install gstreamer 
  sudo apt-get install -y gstreamer1.0-plugins-bad gstreamer1.0-plugins-good python3-gst-1.0 python3-gi gir1.2-gtk-3.0 gstreamer1.0-plugins-ugly
  python3 -m pip install svgwrite kuksa_viss_client
